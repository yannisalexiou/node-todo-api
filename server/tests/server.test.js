...
describe('POST /todos', () => {
  it('should create a new todo', (done) => {
    ...
    request(app)
      ...
      .end((err, res) => {
        ...
        //Make request to the database fetching request
        Todo.find({text}).then((todos) => {
          expect(todos.length).toBe(1); //1 because we added one todo item
  ...
  //Second Test
  //Verifies that the todo does not get created when we send bad data
...
describe('PATCH /todos/:id', () => {
  ...
  it('should clear completedAt when todo is not completed', (done) => {
    ...
    // update text, set copleted to false
    // 200
